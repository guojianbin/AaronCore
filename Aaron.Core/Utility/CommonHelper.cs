...
namespace Aaron.Core.Utility
{
    ...
    public partial class CommonHelper
    {
        ...
        //public static void SetMetaHttpEquiv(Paging page, string httpEquiv, string content)
        //{
        //    if (page.Header == null)
        //        return;
        ...
        ///// </summary>
        ///// <param name="page">Page</param>
        //public static void BindJQuery(Paging page)
        //{
        ...
        //public static void BindJQuery(Paging page, bool useHosted)
        //{
        //    if (page == null)
